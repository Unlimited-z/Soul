...
struct DoubaoImageRequest: Codable {
    let model: String
    let prompt: String
...
struct DoubaoImageResponse: Codable {
    let model: String
    let created: Int
...
struct DoubaoImageData: Codable {
    let url: String?
    let b64Json: String?
...
struct DoubaoImageUsage: Codable {
...
struct DoubaoImageError: Codable {
    let error: DoubaoImageErrorDetail
}

struct DoubaoImageErrorDetail: Codable {
    let message: String
    let type: String?
    let code: String?
}
...
class DoubaoImageService {
    static let shared = DoubaoImageService()
